...
/* package haskell-scraper-0.1.0.0 */
#ifndef VERSION_haskell_scraper
#define VERSION_haskell_scraper "0.1.0.0"
#endif /* VERSION_haskell_scraper */
#ifndef MIN_VERSION_haskell_scraper
#define MIN_VERSION_haskell_scraper(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_scraper */

/* package Unique-0.4.7.8 */
#ifndef VERSION_Unique
#define VERSION_Unique "0.4.7.8"
...
#define CURRENT_COMPONENT_ID "haskell-scraper-0.1.0.0-inplace-haskell-scraper"
